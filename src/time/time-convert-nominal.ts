...
type Sec = Nominal<'Sec', number>
type Min = Nominal<'Min', number>
type Hou = Nominal<'Hou', number>
type Day = Nominal<'Day', number>
type Mth = Nominal<'Mth', number>
type Yrs = Nominal<'Yrs', number>
